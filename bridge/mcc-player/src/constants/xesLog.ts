...
/** 阿里云日志仓库项目名 */
export const ALI_SLS_PROJECT = window.mccEnv === 'test' ? 'peiyou-saas-zaixian-zhibo-tianjige-test' : 'peiyou-saas-zaixian-zhibo-tianjige-prd'// Project名称。

/** 阿里云日志仓库库名 */
export const ALI_SLS_LOGSTORE = 'lele_produce_courseware_log';
